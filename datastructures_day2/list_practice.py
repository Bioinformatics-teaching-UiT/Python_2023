...
# print out an informative message that gives the number of elements in the list, and then the list itself
# no hard coding! (don't count in your head and print it, have the code count for you)
...
# using the remove() method, remove 'dog' - check the list - is this the behaviour you expect?
